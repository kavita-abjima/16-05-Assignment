...
namespace StudentsDetails.Controllers
{
    ...
    public class StudentsDetailsController : ControllerBase
    {
        ...
        public StudentsDetailsController(studentContext context)
        {
            _context = context;
        }
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<StudentsDetailDto>> PostStudentsDetail(StudentsDetailDto studentsDetail)
        {
          if (_context.StudentsDetails == null)
          {
